...
<head>
    ...
    <style>
        ...
        .stats-container {
            display: flex;
            justify-content: space-between; /* جعل الكروت بجانب بعضها */
        ...
        <table>
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>{$row['off_days']}</td>
                        <td>
                            <a href='update_salary_options.php?id={$row['id']}'>decrese</a> 
                            <a href='update_salary_options.php?id={$row['id']}'>increse</a> 
